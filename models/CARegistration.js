...
const caRegistrationSchema = new mongoose.Schema(
  {
    ...
    professionalInformation: {
      ...
      caNumber: { type: String, trim: true, default: '' },
      ...
      yearAdmitted: { type: Number, min: 1900, max: 2100 },
    ...
    firmDetails: {
      ...
      firmPhone: { type: String, trim: true, default: '' },
    ...
    practiceInformation: {
      ...
      hoursOfOperation: { type: String, trim: true, default: '' }
    },
...
caRegistrationSchema.index({ status: 1, createdAt: -1 });
caRegistrationSchema.index({ 'professionalInformation.caNumber': 1 });
caRegistrationSchema.index({ 'firmDetails.firmEmail': 1 });
